...
As soon as I handed off this site, I immediately started thinking of ways to improve it in a future version. This includes but is not limited to: 
* Improving form submission behavior by fully utilizing the POST/REDIRECT/GET model or using existing solutions for forms
* Transfer from Turso to Cloudflare D1 (and get Works to work properly)
* Have an admin login with the ability to moderate comments on the site itself instead of having to log into the database
* Query the database in a more optimal way
* Improve accessibility (aria, keyboard navigation)
* Integrate modern site animations